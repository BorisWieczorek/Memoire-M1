...
class Constants(BaseConstants):
    ...
    interface_contribute_template = 'public_goods_4/interface_contribute.html'

    # """Amount allocated to each player"""
    endowment = c(50) #ball per player in part 4
    multiplier_A = -0.04 #for private in part 4
    gain_B = -3
