...
class Player(BasePlayer):
    ...
    gender = models.StringField(
        label="Quelle est votre sexe ?",
        choices=["Femme", "Homme", "Autre"],
        widget=widgets.RadioSelect(),
    )
    #############################################
    highest_level = models.StringField(
        label="Quelle est votre niveau d'étude ?",
        choices=[
            "Collège sans diplôme",
            "Brevet ou équivalence",
            "Lycée sans diplôme",
            "Baccalaurat",
            "Licence",
            "Master",
    ...
    comments = models.LongStringField(
        label="Optionnel : Si vous avez des commentaires, merci de les écrire ci-dessous. Merci !",
        blank=True,
    )
